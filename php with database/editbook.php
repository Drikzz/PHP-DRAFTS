    <?php 
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            // Retain posted values for all inputs, even if there are errors
            $barcode = isset($_POST['barcode']) ? clean($_POST['barcode']) : $barcode;
            $title = isset($_POST['title']) ? clean($_POST['title']) : $title;
            $author = isset($_POST['author']) ? clean($_POST['author']) : $author;
            $genre = isset($_POST['genre']) ? clean($_POST['genre']) : $genre;
            $publisher = isset($_POST['publisher']) ? clean($_POST['publisher']) : $publisher;
            $pub_date = isset($_POST['pub_date']) ? clean($_POST['pub_date']) : $pub_date;
            $edition = isset($_POST['edition']) ? clean($_POST['edition']) : $edition;
            $copies = isset($_POST['copies']) ? clean($_POST['copies']) : $copies;
            $format = isset($_POST['format']) ? clean($_POST['format']) : $format;
            $age_group = isset($_POST['age_group']) ? array_map('clean', $_POST['age_group']) : $age_group;
            $rating = isset($_POST['rating']) ? clean($_POST['rating']) : $rating;
            $desc = isset($_POST['desc']) ? clean($_POST['desc']) : $desc;
